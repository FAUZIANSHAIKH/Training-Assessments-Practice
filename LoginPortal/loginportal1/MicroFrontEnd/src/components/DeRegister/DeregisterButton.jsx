...
import { fetchUserName } from '../../actions/deregisterAction';
        ...
        if(temp === 'deactivate'){
             ...
             .then(response => {
               ...
               if (response.data.status === 400) {
                 ...
                 window.location.replace("http://ec2-18-235-29-68.compute-1.amazonaws.com:8008/#/deactivateSuccess")
                 window.location.reload("http://ec2-18-235-29-68.compute-1.amazonaws.com:8008/#/deactivateSuccess")
      ...
      if(this.state.deregistertype ==='forgetme'){
        ...
        .then(response => {
          ...
          if (response.data.status === 400) {
            ...
            this.setState({showModal: false});
            window.location.replace("http://ec2-18-235-29-68.compute-1.amazonaws.com:8008/#/forgetmeSuccess")
            window.location.reload("http://ec2-18-235-29-68.compute-1.amazonaws.com:8008/#/forgetmeSuccess")
         console.log("Deactivated");
     }
   });
     }
...
const mapStateToProps = state => ({
  state: state.deregister
})

export default connect(mapStateToProps, {fetchUserName})(DeregisterButton);
