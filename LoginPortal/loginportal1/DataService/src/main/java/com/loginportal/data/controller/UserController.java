...
public class UserController {
	...
	@PostMapping("/delete-user-by-status")
	public String deleteUserByAccountStatus() {
		userService.deleteUserByAccountStatus();
		return "success";
	}
    ...
    public User updateAccountInfo (@RequestBody User user) {
        User userAns= userService.updateAccountInfo(user);
        return userAns;
    }
}
