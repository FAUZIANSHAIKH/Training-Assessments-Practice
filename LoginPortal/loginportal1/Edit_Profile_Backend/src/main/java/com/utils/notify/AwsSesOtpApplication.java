...
public class AwsSesOtpApplication {
	 ...
	 * this.generatedOtp; }
	 * 
	 * @Autowired public AwsSesOtpApplication() {
	 * 
	 * }
	 * 
	 * 
	 * public void doSendEmailWith(String to) { final String FROM =
	 * "majeti.bhargavi@publicissapient.com"; Integer otp = (int)((Math.random() *
	 ...
	 * 
	 * Logger logger = LoggerFactory.getLogger(AwsSesOtpApplication.class); try {
	 ...
	 * client.sendEmail(request); logger.info("Email sent !"); } catch (Exception
	 * ex) { logger.info("The email was not sent. Error message: " +
	 * ex.getMessage()); }
	 * 
	 * }
	 * 
