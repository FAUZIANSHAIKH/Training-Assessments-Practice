...
public class MailNotification {
	 ...
	 * 
	 * @Autowired public MailNotification() { }
	 * 
	 * 
	 * public void doSendEmailWith(String to) { final String FROM =
	 * "majeti.bhargavi@publicissapient.com"; final String SUBJECT =
	 ...
	 * Logger logger = LoggerFactory.getLogger(MailNotification.class); try {
	 ...
	 * client.sendEmail(request); logger.info("Email sent!"); } catch (Exception ex)
